...
const slides = [
    "http://localhost:5000/uploads/gabinete-nox-hummer-tgm.png",
    "http://localhost:5000/uploads/gpu-galax-rtx-3060-ray-tracing-12gb.png",
    "http://localhost:5000/uploads/memoria-xpg-spectrix-d60g.png"
]
...
export const getStaticProps: GetStaticProps = async (context) => {
    ...
    const response = await fetch(`https://api-caiomoizes.vercel.app/memorias/${url}`);
    const data = await response.json();
